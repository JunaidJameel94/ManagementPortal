...
! function (e) {
    ...
    t.prototype = {
        ...
        createNode: function (i) {
            ...
            if (i[e.nodeTitle].includes("_")) {
                var SplitTitle = i[e.nodeTitle].split('_');
                Title = SplitTitle[0];
                MyNodeID = SplitTitle[1];
            }
            else {
                Title = i[e.nodeTitle];
            }
            ...
            e.nodeTemplate ? n.append(e.nodeTemplate(i)) : n.append('<div class="title">' + Title + "</div>").append(void 0 !== e.nodeContent ? '<div class="content">' + (i[e.nodeContent] || "") + "</div><div class='row'><div class='col-sm-12 col-md-6'><button type='button' id='btnAddNode' data-toggle='modal' data-target='#modaladdorganisation' class='btn btn-success' onclick='AddNode(" + MyNodeID + ")'><i class='fas fa-plus'></i></div><div class='col-sm-12 col-md-6'><button type='button' id='btnAddNode' data-toggle='modal' data-target='#modaladdorganisation' class='btn btn-primary' onclick='EditNode(" + MyNodeID + ")'><i class='fas fa-edit'></i></button></div></div>" : "");
            var s = v.extend({}, i);
