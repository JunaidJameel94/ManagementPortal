    ...
    localizestrings: function (b, c) {
      ...
      if (b != null) {
        ...
        this.schedulerLocalization = {
          ...
          editDialogCreateTitleString: "Create New Task Schedule",
          contextMenuEditAppointmentString: "Edit Task Schedule",
          contextMenuCreateAppointmentString: "Create New Task Schedule",
