                ...
                if (result) {
                    ...
                    if (result.data != null) {
                        ...
                        $.each(result.data, function (i, option) {
                            ...
                            var UpdateBtn = (data_[0].AllowUpdate == true) ? '<td><button class="btn btn-sm btn-info  EditRole" data-value="' + option.RoleID + '" type="button"><i class="feather-edit-3"></i></button></td>' : '';
                            var DeleteBtn = (data_[0].AllowDelete == true) ? '<td><button class="btn btn-sm btn-danger btn-block DeleteRole"  data-value="' + option.RoleID + '" type="button"><i class="feather-trash"></i></button></td>' : '';
