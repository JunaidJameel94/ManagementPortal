                ...
                if (result) {
                    ...
                    if (result.data != null) {
                        ...
                        $.each(result.data, function (i, option) {
                            ...
                            var UpdateBtn = (data_[0].AllowUpdate == true) ? '<td><button class="btn btn-sm btn-orange btn-block EditUser" data-value="' + option.UserID + '" data-value1="' + i + '" type="button"><i class="bx bxs-edit"></i></button></td>' : '';
                            var DeleteBtn = (data_[0].AllowDelete == true) ? '<td><button class="btn btn-sm btn-gray btn-block DeleteUser" data-value="' + option.UserID + '" type="button"><i class="bx bxs-trash"></i></button></td>' : '';
